<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Profile Header Card -->
            <div class="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-blue-600 to-indigo-800 rounded-3xl shadow-xl p-6 md:p-10 mb-6">
                    ...
                    <div class="flex-1 text-center md:text-left text-white md:pt-2">
                        ...
                        <div class="flex flex-wrap items-center justify-center md:justify-start gap-3">
                            <div class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 rounded-full py-1.5 px-4 md:px-5 transition-colors shadow-sm">
                                <svg class="w-4 h-4 text-blue-100 shrink-0" fill="currentColor" viewBox="0 0 20 20">
