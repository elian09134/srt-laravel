...
@section('content')
    ...
    <form action="{{ route('admin.content.update') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md space-y-12">
        ...
        <div class="space-y-6">
            <h2 class="text-2xl font-semibold text-gray-800 border-b pb-3">Seksi Departemen HR</h2>
            <div>
                <label for="hr_department_title" class="block text-sm font-medium text-gray-700">Judul</label>
