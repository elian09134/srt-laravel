        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 sticky top-6">
                ...
                <form method="POST" action="{{ route('admin.fptk.approve', $fptk->id) }}" class="mb-4">
                    ...
                    <button type="submit" class="w-full mt-3 inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 font-semibold rounded-lg shadow-md hover:shadow-lg transition transform hover:scale-105" style="color: white !important;">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        Setujui FPTK
                ...
                <form method="POST" action="{{ route('admin.fptk.reject', $fptk->id) }}">
                    ...
                    <button type="submit" class="w-full mt-3 inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 font-semibold rounded-lg shadow-md hover:shadow-lg transition transform hover:scale-105" style="color: white !important;">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
