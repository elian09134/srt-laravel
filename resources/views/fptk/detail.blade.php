        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                @if($fptk->status === 'approved' || $fptk->isCompleted())
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <h3 class="text-lg font-bold text-gray-800 mb-4">Progress Pemenuhan</h3>
                        <div class="flex items-center space-x-3 mb-3">
                            <div class="flex-1 bg-gray-200 rounded-full h-3">
                                <div class="{{ $fptk->isCompleted() ? 'bg-green-600' : 'bg-blue-600' }} h-3 rounded-full transition-all" style="width: {{ $fptk->fulfilled_percent }}%"></div>
                            </div>
                        ...
                        @if($fptk->isCompleted())
                            <div class="mt-3 flex items-center text-green-700 bg-green-50 rounded-lg p-2">
                                ...
                                <span class="text-xs font-semibold">Kebutuhan telah terpenuhi</span>
                            </div>
                        @endif
                    </div>
                @endif
