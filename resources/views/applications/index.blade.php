                ...
                @foreach($applications as $app)
                    <li class="px-6 py-4 flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <div class="mt-1 font-semibold @if(in_array($app->status, ['Diterima','Offering Letter'])) text-green-600 @elseif($app->status === 'Tidak Lanjut') text-red-600 @else text-gray-800 @endif">{{ $app->status }}</div>
