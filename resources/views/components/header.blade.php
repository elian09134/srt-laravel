    ...
    <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-3">
                ...
                @elseif(auth()->user()->role == 'operasional')
                    ...
                    <a href="{{ route('fptk.index') }}" class="px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-yellow-600 to-yellow-700 rounded-xl hover:from-yellow-700 hover:to-yellow-800 transition-all duration-300 hover:shadow-lg">Pengajuan Tenaga Kerja (FPTK)</a>
                @else
    ...
    <div id="mobile-menu" class="hidden md:hidden px-6 pb-4">
        ...
        <div class="mt-4 pt-4 border-t">
             @auth
                ...
                @elseif(auth()->user()->role == 'operasional')
                          <a href="{{ route('fptk.index') }}" class="block text-center py-2 font-medium text-white bg-yellow-600 rounded-lg hover:bg-yellow-700">Pengajuan Tenaga Kerja</a>
                @else
